...
define gui.hover_color = '#511375'

## The color used for a text button when it is selected but not focused. A
## button is selected if it is the current screen or preference value.
define gui.selected_color = '#050505'
...
define gui.interface_text_color = '#050505'
...
define gui.interface_text_font = gui.preference("font", "images/whitrabt.ttf")
...
define gui.nvl_borders = Borders(130, 118, 400, 165)
...
init python:
    ...
    def small():
        ...
        gui.nvl_name_ypos = 150

        gui.nvl_text_width = 1373
        gui.nvl_text_xpos = 518
        gui.nvl_text_ypos = 150
